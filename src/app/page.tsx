...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description:
      "Every asset in our platform is verified by our team to ensure our highest quality standards. Not happy? We offer a 30-day refound garantee.",
  },
  {
    name: "For the Planet",
    Icon: Leaf,
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to DigitalMarket. Every asset on our playform is verified by our team to ensure
